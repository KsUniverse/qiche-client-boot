...
CREATE TABLE "blade_code" (
  ...
  "author" varchar(32) COLLATE "pg_catalog"."default",
  "sub_model_id" varchar(32) COLLATE "pg_catalog"."default",
  "sub_fk_id" varchar(32) COLLATE "pg_catalog"."default",
  "tree_id" varchar(32) COLLATE "pg_catalog"."default",
  "tree_pid" varchar(32) COLLATE "pg_catalog"."default",
  "tree_name" varchar(64) COLLATE "pg_catalog"."default"
)
;
...
-- ----------------------------
BEGIN;
INSERT INTO "blade_dept" VALUES (1123598813738675201, '000000', 0, '0', 1, '布雷德科技', '上海布雷德科技有限公司', 1, NULL, 0);
INSERT INTO "blade_dept" VALUES (1123598813738675202, '000000', 1123598813738675201, '0,1123598813738675201', 1, '常州布雷德', '常州布雷德科技有限公司', 1, NULL, 0);
INSERT INTO "blade_dept" VALUES (1123598813738675203, '000000', 1123598813738675201, '0,1123598813738675201', 1, '苏州布雷德', '苏州布雷德科技有限公司', 1, NULL, 0);
COMMIT;
...
INSERT INTO "blade_menu" VALUES (1123598815738675309, 1123598815738675307, 'data_scope', '数据权限', 'menu', '/authority/datascope', '', 2, 1, 0, 1, '', NULL, 0);
...
INSERT INTO "blade_menu" VALUES (1123598815738675311, 1123598815738675307, 'api_scope', '接口权限', 'menu', '/authority/apiscope', '', 3, 1, 0, 1, '', NULL, 0);
...
INSERT INTO "blade_menu" VALUES (1161272593873321996, 1123598815738675217, 'model', '数据模型设计', 'menu', '/tool/model', '', 3, 1, 0, 1, '', '', 0);
INSERT INTO "blade_menu" VALUES (1164733369658963251, 1123598815738675210, 'elk', 'ELK监控', 'menu', 'http://localhost:5601/', '', 3, 1, 0, 2, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733369658963252, 1123598815738675210, 'zipkin', 'Zipkin监控', 'menu', 'http://localhost:9411/', '', 4, 1, 0, 2, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733369658963253, 1123598815738675210, 'turbine', 'Turbine监控', 'menu', 'http://localhost:7003/hystrix', '', 5, 1, 0, 2, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733369658963254, 1123598815738675210, 'sentinel', 'Sentinel管理', 'menu', 'http://localhost:8858', '', 6, 1, 0, 2, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733369658963255, 1123598815738675210, 'es', 'Elasticsearch管理', 'menu', 'http://localhost:9100/', '', 7, 1, 0, 2, '', NULL, 0);
...
INSERT INTO "blade_menu" VALUES (1164733389658963251, 1123598815738675298, 'xxljob', '任务调度', 'menu', 'http://localhost:7009/xxl-job-admin', '', 5, 1, 0, 2, '', NULL, 0);
...
INSERT INTO "blade_menu" VALUES (1164733379658963251, 1123598815738675203, 'dictbiz', '业务字典', 'menu', '/system/dictbiz', '', 5, 1, 0, 1, '', NULL, 0);
...
INSERT INTO "blade_menu" VALUES (1164733399669962302, 1164733399669962301, 'report_setting', '报表配置', 'menu', 'http://localhost:8108/ureport/designer', '', 1, 1, 0, 2, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962303, 1164733399669962301, 'report_list', '报表列表', 'menu', '/report/reportlist', '', 2, 1, 0, 1, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962304, 1164733399669962301, 'report_notice', '公告报表', 'menu', 'http://localhost:8108/ureport/preview?_u=blade-notice.ureport.xml', '', 3, 1, 0, 2, '', NULL, 0);
COMMIT;

-- ----------------------------
-- Table structure for blade_model
-- ----------------------------
DROP TABLE IF EXISTS "blade_model";
...
-- ----------------------------
DROP TABLE IF EXISTS "blade_model_prototype";
...
INSERT INTO "blade_param" VALUES (1123598819738675203, '账号错误锁定次数', 'account.failCount', '5', '锁定次数', 1123598821738675201, 1123598813738675201, '2021-12-01 12:00:00', 1123598821738675201, '2021-12-01 12:00:00', 1, 0);
...
-- ----------------------------
ALTER TABLE "blade_model" ADD CONSTRAINT "blade_model_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table blade_model_prototype
-- ----------------------------
ALTER TABLE "blade_model_prototype" ADD CONSTRAINT "blade_model_prototype_pkey" PRIMARY KEY ("id");
